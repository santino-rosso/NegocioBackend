...
describe('Caracteristica Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'caracteristica', component: CaracteristicaComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to caracteristicaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCaracteristicaIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCaracteristicaIdentifier).toHaveBeenCalledWith(entity);
