...
describe('Opcion Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [OpcionUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call Personalizacion query and add missing value', () => {
      ...
      const personalizacion: IPersonalizacion = { id: 17436 };
      opcion.personalizacion = personalizacion;

      const personalizacionCollection: IPersonalizacion[] = [{ id: 12565 }];
    ...
    it('Should update editForm', () => {
      const opcion: IOpcion = { id: 456 };
      const personalizacion: IPersonalizacion = { id: 86058 };
      opcion.personalizacion = personalizacion;
