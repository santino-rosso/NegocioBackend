...
describe('Dispositivo Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'dispositivo', component: DispositivoComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to dispositivoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDispositivoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDispositivoIdentifier).toHaveBeenCalledWith(entity);
