...
describe('Personalizacion Management Component', () => {
  let comp: PersonalizacionComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'personalizacion', component: PersonalizacionComponent }]),
      ...
      .overrideTemplate(PersonalizacionComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.personalizacions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to personalizacionService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPersonalizacionIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPersonalizacionIdentifier).toHaveBeenCalledWith(entity);
