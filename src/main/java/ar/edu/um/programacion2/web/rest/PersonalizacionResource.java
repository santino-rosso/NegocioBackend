...
public class PersonalizacionResource {
    ...
    private final Logger log = LoggerFactory.getLogger(PersonalizacionResource.class);
    ...
    public ResponseEntity<PersonalizacionDTO> createPersonalizacion(@Valid @RequestBody PersonalizacionDTO personalizacionDTO)
        ...
        return ResponseEntity
            .created(new URI("/api/personalizacions/" + result.getId()))
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/personalizacions/{id}")
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/personalizacions/{id}", consumes = { "application/json", "application/merge-patch+json" })
     ...
     */
    @GetMapping("/personalizacions/{id}")
    public ResponseEntity<PersonalizacionDTO> getPersonalizacion(@PathVariable Long id) {
     ...
     */
    @DeleteMapping("/personalizacions/{id}")
    public ResponseEntity<Void> deletePersonalizacion(@PathVariable Long id) {
